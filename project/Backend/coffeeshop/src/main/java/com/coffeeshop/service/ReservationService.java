...
public class ReservationService {
    ...
    public Reservation createReservation(ReservationRequest request) {
        ...
        Table selectedTable = tableRepository.findById(request.tableId())//YEU CAU DA GUI
        ...
        //kiem tra khoang thoi gian dat ban xem bij trung lap hay ko
    ...
    public List<Reservation> getReservationsByUserId(Long userId) {
        User currentUser = (User) SecurityContextHolder.getContext().getAuthentication().getPrincipal();//lấy user hiện tại
        if (!currentUser.getId().equals(userId) && !currentUser.getRole().equals(Role.ADMIN)) {
            throw new RuntimeException("Access denied.");//từ chối
        }
