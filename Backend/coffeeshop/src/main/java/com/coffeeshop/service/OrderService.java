...
public class OrderService {
    ...
    private OrderResponse toOrderResponse(Order order) {
        ...
        Hibernate.initialize(order.getTable());
        if (order.getTable() != null) {
            Hibernate.initialize(order.getTable().getReservations());
            order.getTable().getReservations().forEach(reservation -> Hibernate.initialize(reservation.getUser()));
        }
